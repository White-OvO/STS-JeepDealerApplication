...
@RequestMapping("/jeeps") // this  is like a chapter heading of a book  a chapter title 
...
/////////////////////////	@schema takes a parameter which is called an implementation
			...
			allowEmptyValue = false, // if na empty value is imputed it will be replaced with an null
			required = false,
...
//Steop 17:	Add the @GetMapping annotation and the @ResponseStatus(code = HttpStatus.OK) annotation as method-level annotations to the fetchJeeps method.
...
List<Jeep> fetchJeeps(@RequestParam JeepModel model,            //request param is named JeepModel if the name was not here it would inherit the parameter name
